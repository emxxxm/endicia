...
public class QueryStrings {
	...
	public static String MAIL_CLASS_FCM = "FCM";
	public static String MAIL_CLASS_STD = "STD";
	public static String MAIL_CLASS_PER = "PER";
	public static String MAIL_CLASS_PKG = "PKG";
